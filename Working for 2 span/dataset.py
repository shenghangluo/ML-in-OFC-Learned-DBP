...
class DatasetMNIST(object):
    ...
    def load_data(self):
        ...
        x_X_pol_Real = np.loadtxt(
            fname="C:/MASc/Learned_LDBP/Fiber_optic_transmission_system/Dataset_for_Training_DNN/Dataset_for_Training_DNN/Dataset_x_X_pol_Real.txt")[:2048]#1600000]
        x_X_pol_Image = np.loadtxt(
            fname="C:/MASc/Learned_LDBP/Fiber_optic_transmission_system/Dataset_for_Training_DNN/Dataset_for_Training_DNN/Dataset_x_X_pol_Imag.txt")[:2048]#1600000]
        y_X_pol_Real = np.loadtxt(
            fname="C:/MASc/Learned_LDBP/Fiber_optic_transmission_system/Dataset_for_Training_DNN/Dataset_for_Training_DNN/Dataset_y_X_pol_Real.txt")[:4096]#3200000]
        y_X_pol_Image = np.loadtxt(
            fname="C:/MASc/Learned_LDBP/Fiber_optic_transmission_system/Dataset_for_Training_DNN/Dataset_for_Training_DNN/Dataset_y_X_pol_Imag.txt")[:4096]#3200000]
        ...
        # Test Power 1
        x_X_pol_Real = np.loadtxt(
            fname="C:/MASc/Learned_LDBP/New_Data/Dataset_x_X_pol_Real.txt")[:2048]
        x_X_pol_Image = np.loadtxt(
            fname="C:/MASc/Learned_LDBP/New_Data/Dataset_x_X_pol_Imag.txt")[:2048]
        y_X_pol_Real = np.loadtxt(
            fname="C:/MASc/Learned_LDBP/New_Data/Dataset_y_X_pol_Real.txt")[:4096]
        y_X_pol_Image = np.loadtxt(
            fname="C:/MASc/Learned_LDBP/New_Data/Dataset_y_X_pol_Imag.txt")[:4096]
        ...
        # Test Power 2
        x_X_pol_Real = np.loadtxt(
            fname="C:/MASc/Learned_LDBP/Fiber_optic_transmission_system/Dataset_for_Training_DNN/Testing_data/2_Dataset_x_X_pol_Real.txt")[
                       :2048]
        x_X_pol_Image = np.loadtxt(
        ...
        # Test Power 3
        x_X_pol_Real = np.loadtxt(
            fname="C:/MASc/Learned_LDBP/Fiber_optic_transmission_system/Dataset_for_Training_DNN/Testing_data/3_Dataset_x_X_pol_Real.txt")[
                       :2048]
        x_X_pol_Image = np.loadtxt(
        ...
        # Test Power 4
        x_X_pol_Real = np.loadtxt(
            fname="C:/MASc/Learned_LDBP/Fiber_optic_transmission_system/Dataset_for_Training_DNN/Testing_data/4_Dataset_x_X_pol_Real.txt")[
                       :2048]
        x_X_pol_Image = np.loadtxt(
        ...
        # Test Power 5
        x_X_pol_Real = np.loadtxt(
            fname="C:/MASc/Learned_LDBP/Fiber_optic_transmission_system/Dataset_for_Training_DNN/Testing_data/5_Dataset_x_X_pol_Real.txt")[
                       :2048]
        x_X_pol_Image = np.loadtxt(
