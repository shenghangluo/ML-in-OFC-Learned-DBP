...
class Linear_W1(object):
    def __init__(self, X_real, X_image, layer_number, span_number):
        ...
        self.W1_real = tf.math.scalar_mul(0.1, self.W1_real)
        self.W1_Processed_real = Weight_Transform_whole(self.W1_real, n=N)
        ...
        self.W1_image = tf.math.scalar_mul(0.1, self.W1_image)
        self.W1_Processed_image = Weight_Transform_whole(self.W1_image, n=N)
