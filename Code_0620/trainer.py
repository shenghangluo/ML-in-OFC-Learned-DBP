    ...
    def train_model(self):
        ...
        with tf.Session() as sess:
            ...
            for epoch in range(0, self._n_epochs):
                ...
                loss.eval(feed_dict={self._model.X_real: data['X_valid_real_1'], self._model.X_image: data['X_valid_image_1'], self._model.y_real: data['y_valid_real_1'], self._model.y_image: data['y_valid_image_1']}),
