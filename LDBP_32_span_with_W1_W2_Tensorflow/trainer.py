...
#        K.clear_session()
        ...
        with tf.Session(config=tf_config) as sess:
            ...
            for epoch in range(0, self._n_epochs):
                ...
                for X_batch_real, y_batch_real, X_batch_image, y_batch_image in self._dataset.shuffle_batch(data['X_train_real'], data['y_train_real'], data['X_train_image'], data['y_train_image'], self._batch_size):
                    _, loss_batch = sess.run([training_op, loss], feed_dict={self._learning_rate: learning_rate, self._model.X_real_in: X_batch_real, self._model.X_image_in: X_batch_image, self._model.y_real: y_batch_real,
                                                                             self._model.y_image: y_batch_image, self._model.mask: mask})
                ...
                loss.eval(feed_dict={self._learning_rate: learning_rate, self._model.X_real_in: data['X_test_real_1'], self._model.X_image_in: data['X_test_image_1'], self._model.y_real: data['y_test_real_1'], self._model.y_image: data['y_test_image_1'], self._model.mask: mask}),
                     "Q factor:", Q.eval(feed_dict={self._learning_rate: learning_rate, self._model.X_real_in: data['X_test_real_1'], self._model.X_image_in: data['X_test_image_1'], self._model.y_real: data['y_test_real_1'], self._model.y_image: data['y_test_image_1'], self._model.mask: mask}))
            ...
            real = self._model.get_reconstruction()[0].eval(
                feed_dict={self._learning_rate: learning_rate, self._model.X_real_in: data['X_test_real_1'], self._model.X_image_in: data['X_test_image_1'], self._model.y_real: data['y_test_real_1'], self._model.y_image: data['y_test_image_1'], self._model.mask: mask})
            ...
            #     feed_dict={self._learning_rate: learning_rate, self._model.X_real_in: data['X_test_real_1'], self._model.X_image_in: data['X_test_image_1'], self._model.y_real: data['y_test_real_1'], self._model.y_image: data['y_test_image_1'], self._model.mask: 0})
            #
            # #print("power = 1:", loss.eval(
